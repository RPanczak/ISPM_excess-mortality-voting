...
if(TRUE) {
  ...
  saveRDS(model1.5_full,file="results_inla_v2/model1.5_full.rds")
}

# merge
if(TRUE) {
  model1.5_full = readRDS("results_inla_v2/model1.5_full.rds")
  model1.5_merg = inla.merge(loo=model1.5_full)
  saveRDS(model1.5_merg,file="results_inla_v2/model1.5_merg.rds")
}
...
if(TRUE) {
  ...
  saveRDS(model1.4b_full,file="results_inla_v2/model1.4b_full.rds")
}

# merge
if(TRUE) {
  model1.4b_full = readRDS("results_inla_v2/model1.4b_full.rds")
  model1.4b_merg = inla.merge(loo=model1.4b_full)
  saveRDS(model1.4b_merg,file="results_inla_v2/model1.4b_merg.rds")
}

# analyse
if(FALSE) {
  model1.4b_merg = readRDS("results_inla_v2/model1.4b_merg.rds")
